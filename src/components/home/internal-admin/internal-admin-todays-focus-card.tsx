...
import type { InternalAdminFocusItem } from "@/lib/mock-internal-admin-home"

function FocusItemRow({ item, rank }: { item: InternalAdminFocusItem; rank: number }) {
  return (
...
export function InternalAdminTodaysFocusCard({ items }: { items: InternalAdminFocusItem[] }) {
  return (
