...
import type { ClientRecruiterFocusItem } from "@/lib/mock-client-recruiter-home"

function FocusItemRow({ item, rank }: { item: ClientRecruiterFocusItem; rank: number }) {
  return (
...
export function ClientRecruiterTodaysFocusCard({ items }: { items: ClientRecruiterFocusItem[] }) {
  return (
