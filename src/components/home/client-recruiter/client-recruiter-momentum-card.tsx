...
import type { ClientRecruiterMomentumData } from "@/lib/mock-client-recruiter-home"

export function ClientRecruiterMomentumCard({ data }: { data: ClientRecruiterMomentumData }) {
  return (
